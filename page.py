...
title = dbc.Jumbotron([
    ...
    dbc.Container([
            html.H1("FC DEI Survey Dashboard", className='display-3 text-center', style={'maxWidth': '1350px'}),
            html.Br(),
            html.H6("Contributors: DeShan Allison, Bianca A. Hernandez, Michelle Le, Kenya Lewis, Stephanie Perrone, Julie Roebuck, Ebonie Trice, Mary Young and Tiffany Nicely-Williams", className='lead text-center', style={'maxWidth': '1350px'}),
            html.Br(),
            html.Br(),
        dbc.Row([
            html.Br(),
        ...
        ], style={'maxWidth': '1350px'}, fluid=True), 
    ])     
...
descriptive_stats = html.Div([
            ...
            dbc.Row([
                dbc.Col(width=1),
                html.H3("Interesting findings", className='lead text-center', style={'maxWidth': '1350px'}),
                dbc.Col(width=1),  
            ]),
            html.Br(),
            dbc.Row([
...
demo_row = html.Div([
    ...
    dbc.Row([
        dbc.Col(width=1),
        html.H3("Personal experience X demographics", className='lead text-center', style={'maxWidth': '1350px'}), 
        dbc.Col(width=1),  
            ]),
    html.Br()
