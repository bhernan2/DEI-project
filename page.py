...
title = dbc.Jumbotron([
    ...
    dbc.Container([
            html.H1("FC DEI Survey Dashboard", className='display-3 text-center', style={'maxWidth': '1400px'}),
            html.Br(),
            html.H6("Contributors: DeShan Allison, Bianca A. Hernandez, Michelle Le, Kenya Lewis, Stephanie Perrone, Julie Roebuck, Ebonie Trice, Mary Young and Tiffany Nicely-Williams", className='lead text-center', style={'maxWidth': '1400px'}),
            html.Br(),
            html.Br(),
        dbc.Row([
            html.Br(),
...
descriptive_stats = dbc.Jumbotron([
    dbc.Container([
        html.Br(),
        dbc.Row([
            html.H3("Interesting findings", className='text-left', style={'maxWidth': '1400px'})
        ...
        dbc.Row([  
            ...
            ], className="mb-5", style={'maxWidth': '1400px'}),        
        dbc.Row([
            dbc.Col(
...
demo_row = html.Div([
    ...
    dbc.Row([
        ...
        html.H3("Personal experience X demographics", className='lead text-center', style={'maxWidth': '1400px'}), 
...
output_row=dbc.Jumbotron([
    ...
    dbc.Row([
        html.Br(),
        html.H3("Individual experience X demographics", className='text-left', style={'maxWidth': '1400px'}),
        html.Br(),
        ], style={'maxWidth': '1400px'}),
    html.Br(), 
    dbc.Container([
