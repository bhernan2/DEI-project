...
descriptive_stats = html.Div([
            ...
            dbc.Row([
                dbc.Col(width=1),
                html.4("Interesting findings", className='text-center', style={'maxWidth': '1500px'}),
                dbc.Col(width=1),  
            ]),
            html.Br(),
            dbc.Row([
...
demo_row = html.Div([
    ...
    dbc.Row([
        dbc.Col(width=1),
        html.4("Personal experience X demographics", className='text-center', style={'maxWidth': '1500px'}), 
        dbc.Col(width=1),  
            ]),
    html.Br()
